<div>
    <div class="page-content">
        <section class="row">
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
                                <h5 class="mb-0 fw-bold">Statistik Pengadaan Bulanan</h5>
            ...
            {{-- Kolom kanan: Pengadaan terbaru dan tombol logout --}}
            <div class="col-12 col-lg-3">

                {{-- Pengadaan Terbaru --}}
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-header bg-light py-3">
                        <h5 class="mb-0 fw-bold">Pengadaan Terbaru</h5>
                    </div>
    ...
    <style>
        ...
        .stats-icon i {
            ...
            transform: translateY(2px); /* biar rata tengah */

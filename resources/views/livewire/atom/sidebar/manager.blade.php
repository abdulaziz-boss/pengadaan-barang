        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('manager.categories.index') ? 'active' : '' }}">
                    <a href="{{ route('manager.categories.index')}}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-stack"></i>
                        <span>List Kategori</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('manager.barangs.index') ? 'active' : '' }}">
                    <a href="{{ route('manager.barangs.index') }}" class="sidebar-link" wire:navigate>
                ...
                <li class="sidebar-item {{ request()->routeIs('manager.riwayatpengadaan.*') ? 'active' : '' }}">
                    <a href="{{ route('manager.riwayatpengadaan.index') }}" class="sidebar-link" wire:navigate>
                ...
                <li class="sidebar-item {{ request()->routeIs('manager.users.index') ? 'active' : '' }}">
                    <a href="{{ route('manager.users.index') }}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-people-fill"></i>
                        <span>Menejemen User</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('manager.profile.index') ? 'active' : '' }}">
                    <a href="{{ route('manager.profile.index') }}" class="sidebar-link" wire:navigate>

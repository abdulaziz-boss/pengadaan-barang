<div>
                                    ...
                                    <div class="list-group-item border-0 px-3 py-3 pengadaan-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="flex-grow-1 me-2 text-truncate">
                                                ...
                                                <small class="text-muted d-block">Pengaju: {{ $p->pengaju->name ?? '-' }}</small>
                                            </div>
    ...
    function loadChart() {
        ...
        window.managerChart = new ApexCharts(chartEl, {
    ...
    <style>
        ...
        .stats-card:hover { transform: translateY(-6px); box-shadow: 0 8px 20px rgba(0,0,0,0.12); }

        .stats-icon { width:55px;height:55px;border-radius:14px;display:flex;align-items:center;justify-content:center;margin-bottom:.75rem;line-height:1;position:relative;transition: transform 0.3s ease, box-shadow 0.3s ease; }
        ...
        .stats-icon i { font-size:1.6rem; color:#fff; transform:translate(-5px,-3px); }

        .stats-card h6 { color:#6c757d; font-weight:500; font-size:.85rem; margin-bottom:.25rem; }
        .stats-card h4 { font-weight:700; color:#1b1b3a; }

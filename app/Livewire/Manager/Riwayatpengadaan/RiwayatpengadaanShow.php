...
class RiwayatpengadaanShow extends Component
{
    public $pengadaan;

    // Mount dengan ID pengadaan
    public function mount($id)
    {
        // Load pengajuan + pengaju + items + barang
    ...
    // Export Excel menggunakan Blade
    ...
    {
        return view('livewire.manager.riwayatpengadaan.riwayatpengadaan-show');
    }
}
